...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╔══════════╬════╬══════════╗ \n"
        f"╟⟩⟩ 🤴 • `ᴏᴡɴᴇʀ    :`[{DEFAULTUSER}](t.me/oppaidaisukii)\n"
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [Repo](https://github.com/fhmyngrh/Zelda-Userbot) | [Grup](t.me/Friendlycircle) | [Owner](t.me/oppaidaisukii) | [Instagram](https://Instagram.com/fhmyngrh_)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
